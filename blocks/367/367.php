        ...
        <div class="type-367">
            <div class="homepage_blog">
                <div class="container">
                    ...
                    <div id="homepage_blog" class="swiper-container swiper-container-horizontal">
                        <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px); transition-duration: 0ms;">
                            <div class="swiper-slide swiper-slide-duplicate swiper-slide-active" data-swiper-slide-index="2" style="width: 1170px; margin-right: 30px;">
                                <div class="article_img col">
                                    <img src="images/Home_14_03_1024x1024.jpg" alt="Easy-Peasy Way To Add Color  To A&nbsp;Journal"></div>
                                <div class="blog_wrapper col">
                            ...
                            <div class="swiper-slide swiper-slide-next" data-swiper-slide-index="0" style="width: 1170px; margin-right: 30px;">
                                <div class="article_img col">
                            ...
                            <div class="swiper-slide swiper-slide-duplicate swiper-slide-prev" data-swiper-slide-index="0" style="width: 1170px; margin-right: 30px;">
                                <div class="article_img col">
                                    <img src="images/blog3_1024x1024.jpg" alt="In this case, our services are what you need.">
                                </div>
                                <div class="blog_wrapper col">
